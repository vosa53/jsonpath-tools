...
import { jsonpath, updateQueryArgumentEffect, updateQueryArgumentTypeEffect, updateQueryOptionsEffect } from "../lib";
import { defaultQueryOptions, jsonSchemaToType } from "@jsonpath-tools/jsonpath";

/**
 * JSONPath CodeMirror extension testing entry point.
 */
